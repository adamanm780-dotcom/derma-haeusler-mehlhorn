/* ==========================================================================
   ...
   Behandlungen — laufen ueber E-Mail, damit vorab geklaert
...
(function () {
  ...
  var VARIANTEN = {
    aesthetik: {
      ...
      text: 'Schreiben Sie uns bei &auml;sthetischen Anfragen bitte eine E-Mail &ndash; <strong>unsere Mitarbeiter antworten Ihnen innerhalb ' +
            'weniger Stunden!</strong>'
    },
    medizin: {
      titel: 'Wir melden uns <em>zeitnah</em>',
      text: 'Schreiben Sie uns f&uuml;r Ihren Termin bitte eine E-Mail &ndash; <strong>unsere Mitarbeiter antworten Ihnen innerhalb ' +
            'weniger Stunden!</strong>'
    }
  };
